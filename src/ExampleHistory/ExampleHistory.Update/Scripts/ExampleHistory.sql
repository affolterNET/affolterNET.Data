...
create table ExampleHistory.T_DemoTable(
    ...
    Type uniqueidentifier
        constraint FK_ExampleHistory_T_DemoTable_ExampleHistory_T_DemoTableType
            foreign key (Type) references ExampleHistory.T_DemoTableType (Id),
...
insert into ExampleHistory.T_DemoTable (Id, Message, Type) values (newid(), 'It is working!', '36a072b9-7216-4b99-bf8d-79730a4a1f37')
