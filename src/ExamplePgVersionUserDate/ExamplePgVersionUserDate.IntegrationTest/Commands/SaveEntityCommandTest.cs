        ...
        public void SaveEntityCommandTestOk()
        {
            CQB<SaveInfo>().Arrange(db =>
            {
                var dto = new example_pg_version_user_date_demo_table
                {
                    ...
                    TypeId = ExamplePgVersionUserDateDemoTableTypes.Drei
                };
                return new SaveEntityCommand<example_pg_version_user_date_demo_table>(dto, "tinu", true, example_pg_version_user_date_demo_table.Cols.Status);
