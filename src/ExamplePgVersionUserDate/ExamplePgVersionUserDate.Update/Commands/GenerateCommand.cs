...
namespace ExamplePgVersionUserDate.Update.Commands
{
    public class GenerateCommand : AsyncCommand<GenerateCommand.Settings>
    {
        ...
        public class Settings : CommandSettings
        {
            ...
            [DefaultValue("ExamplePgVersionUserDate.Data")]
            public string NameSpace { get; set; } = null!;

            [CommandArgument(2, "[targetfile]")]
            [DefaultValue("../../ExamplePgVersionUserDate.Data/Dto.cs")]
        ...
        {
            {
                var tlp = new GeneratorCfg()
                    ...
                    .WithTableNameExclusion("public_SchemaVersions")
                    .WithSchemaExclusion("public")
                    .WithSchemaExclusion("example_pg")
                    .WithSchemaExclusion("example_pg_history")
                    .WithSchemaExclusion("example_pg_user_date")
                    .WithSchemaExclusion("example_pg_version")
                    .WithSchemaExclusion("example_pg_version_user_date_history")
                    .WithContentsList("example_pg_version_user_date", "demo_table_type", "id", "name", "ExamplePgVersionUserDateDemoTableTypes")
                    .WithUsing("System")
                    ...
                    .WithInsertDate(insDate => insDate == "insert_date")
                    .WithInsertUser(insUser => insUser == "insert_user")
                    .WithUpdateDate(updDate => updDate == "update_date")
                    .WithUpdateUser(updUser => updUser == "update_user")
                    .WithVersion(version => version == "version_timestamp")
