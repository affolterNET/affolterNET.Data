...
namespace ExamplePgVersionUserDateHistory.Update.Commands
{
    public class GenerateCommand : AsyncCommand<GenerateCommand.Settings>
    {
        ...
        public class Settings : CommandSettings
        {
            ...
            [DefaultValue("ExamplePgVersionUserDateHistory.Data")]
            public string NameSpace { get; set; } = null!;

            [CommandArgument(2, "[targetfile]")]
            [DefaultValue("../../ExamplePgVersionUserDateHistory.Data/Dto.cs")]
        ...
        {
            {
                var tlp = new GeneratorCfg()
                    ...
                    .WithSchemaExclusion("example_pg_version_user_date")
                    .WithContentsList("example_pg_version_user_date_history", "demo_table_type", "id", "name", "ExamplePgVersionUserDateHistoryDemoTableTypes")
                    .WithUsing("System")
