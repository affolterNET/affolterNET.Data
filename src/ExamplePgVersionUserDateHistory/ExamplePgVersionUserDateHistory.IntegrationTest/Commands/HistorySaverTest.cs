...
public class HistorySaverTest: IntegrationTest
{
    ...
    {
        var qry = new SaveEntityCommand<example_pg_version_user_date_history_demo_table>(new example_pg_version_user_date_history_demo_table());
    ...
    {
        var qry = new LoadEntityQuery<example_pg_version_user_date_history_demo_table>();
