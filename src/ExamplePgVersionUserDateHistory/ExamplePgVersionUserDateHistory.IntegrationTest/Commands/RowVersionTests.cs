    ...
    public void CanInsert()
    {
        CQB<SaveInfo>()
            .Arrange(db =>
            {
                ...
                return new SaveEntityCommand<example_pg_version_user_date_history_demo_table>(dto);
            })
    ...
    public void CanUpdate()
    {
        CQB<SaveInfo>()
            .Arrange(db =>
            {
                ...
                dto.SetInserted("test");
                db.Insert(dto);
                var reloaded = db.SelectById<example_pg_version_user_date_history_demo_table>(dto.Id);
                Assert.NotNull(reloaded);
                reloaded.Message = "I was reloaded";
                return new SaveEntityCommand<example_pg_version_user_date_history_demo_table>(reloaded);
            })
            .ActAndAssert((result, ah) =>
            {
    ...
    public void CanNotUpdateWhenChanged()
    {
        var builder = CQB<SaveInfo>()
            .Arrange(db =>
            {
                ...
                // different update
                db.Update<example_pg_version_user_date_history_demo_table>().WithUpdate(example_pg_version_user_date_history_demo_table.Cols.Message.StripQuoting(), "somebody else").Execute();
