...
namespace ExamplePgVersionUserDateHistory.Data
{
    ...
    public class example_pg_version_user_date_history_demo_table : IDtoBase
    {
        ...
        public string GetSelectCommand(int maxCount = 1000, params string[] excludedColumns)
        {
            ...
            return $"select {cols.JoinCols(false, affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes)} from \"example_pg_version_user_date_history\".\"demo_table\" where (@Id is null or \"id\"=@Id) limit {maxCount}";
        }
    ...
    public class example_pg_version_user_date_history_demo_table_type : IDtoBase
    {
        ...
        public string GetSelectCommand(int maxCount = 1000, params string[] excludedColumns)
        {
            ...
            return $"select {cols.JoinCols(false, affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes)} from \"example_pg_version_user_date_history\".\"demo_table_type\" where (@Id is null or \"id\"=@Id) limit {maxCount}";
        }
    ...
    public class example_pg_version_user_date_history_v_demo : IViewBase
    {
        ...
        {
            var cols = "\"id\", \"message\", \"type_id\", \"status\", \"insert_date\", \"insert_user\", \"update_date\", \"update_user\", \"version_timestamp\"".GetColumns(affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes, excludedColumns);
            return $"select {cols.JoinCols(false, affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes)} from \"example_pg_version_user_date_history\".\"v_demo\" limit {maxCount}";
        }
