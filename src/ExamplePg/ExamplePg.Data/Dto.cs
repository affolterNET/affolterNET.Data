...
namespace ExamplePg.Data
{
    ...
    public class example_pg_demo_table : IDtoBase
    {
        ...
        {
            var cols = "\"id\", \"message\", \"type_id\", \"status\", \"date_test\", \"date_end_test\"".GetColumns(affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes, excludedColumns);
            return $"select {cols.JoinCols(false, affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes)} from \"example_pg\".\"demo_table\" where (@Id is null or \"id\"=@Id) limit {maxCount}";
        }
        ...
        public example_pg_demo_table GetFromDb(IDbConnection conn, IDbTransaction trsact)
        {
            return conn.QueryFirstOrDefault<example_pg_demo_table>(this.GetSelectCommand(1), this, trsact);
        }
    ...
    public class example_pg_demo_table_type : IDtoBase
    {
        ...
        public string GetSelectCommand(int maxCount = 1000, params string[] excludedColumns)
        {
            ...
            return $"select {cols.JoinCols(false, affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes)} from \"example_pg\".\"demo_table_type\" where (@Id is null or \"id\"=@Id) limit {maxCount}";
        }
        ...
        public example_pg_demo_table_type GetFromDb(IDbConnection conn, IDbTransaction trsact)
        {
            return conn.QueryFirstOrDefault<example_pg_demo_table_type>(this.GetSelectCommand(1), this, trsact);
        }
    ...
    public class example_pg_v_demo : IViewBase
    {
        ...
        {
            var cols = "\"id\", \"message\", \"type_id\", \"status\", \"date_test\", \"date_end_test\"".GetColumns(affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes, excludedColumns);
            return $"select {cols.JoinCols(false, affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes)} from \"example_pg\".\"v_demo\" limit {maxCount}";
        }
