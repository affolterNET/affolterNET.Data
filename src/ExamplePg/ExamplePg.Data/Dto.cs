...
namespace ExamplePg.Data
{
    public class DtoFactory : IDtoFactory
    {
        public IDtoBase Get<T>()
            where T : IDtoBase
        {
            if (typeof(example_pg_demo_table) == typeof(T))
            {
                return new example_pg_demo_table();
            }

            if (typeof(example_pg_demo_table_type) == typeof(T))
            {
                return new example_pg_demo_table_type();
            }
    ...
    public class ViewFactory : IViewFactory
    {
        public IViewBase Get<T>()
            where T : IViewBase
        {
            if (typeof(example_pg_v_demo) == typeof(T))
            {
                return new example_pg_v_demo();
            }
    ...
    public class example_pg_demo_table : IDtoBase
    {
        public const string TABLE_NAME = "example_pg.demo_table";
        [Da.DataType("uuid")]
        [Da.Key]
        ...
        public static class Cols
        {
            ...
            public const string DateEndTest = "\"date_end_test\"";
            public const string DateTest = "\"date_test\"";
        ...
        {
            var cols = "\"id\"|Id, \"message\"|Message, \"type_id\"|TypeId, \"status\"|Status, \"date_test\"|DateTest, \"date_end_test\"|DateEndTest".GetColumns(affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes, excludedColumns);
            return $"select {cols.JoinColsForSelect(affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes)} from \"example_pg\".\"demo_table\" where (@Id::uuid is null or \"id\"=@Id) limit {maxCount}";
        }

        public string GetInsertCommand(bool returnScopeIdentity = false, params string[] excludedColumns)
        {
            var cols = "\"id\"|Id, \"message\"|Message, \"type_id\"|TypeId, \"status\"|Status, \"date_test\"|DateTest, \"date_end_test\"|DateEndTest".GetColumns(affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes, excludedColumns);
            var sql = $"insert into \"example_pg\".\"demo_table\" ({cols.JoinCols(false, affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes)}) values ({cols.JoinCols(true, affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes)})";
        ...
        {
            var cols = "\"id\"|Id, \"message\"|Message, \"type_id\"|TypeId, \"status\"|Status, \"date_test\"|DateTest, \"date_end_test\"|DateEndTest".GetColumns(affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes, excludedColumns);
            return $"update \"example_pg\".\"demo_table\" set {cols.JoinForUpdate(affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes)} where \"id\"=@Id";
        }

        public string GetDeleteCommand()
        {
            return "delete from \"example_pg\".\"demo_table\" where \"id\"=@Id";
        }

        public string GetDeleteAllCommand()
        {
            return "delete from \"example_pg\".\"demo_table\"";
        }
        ...
        public string GetSaveByIdCommand(bool select = false, params string[] excludedColumns)
        {
            ...
            return @$"
                        ...
                        SELECT 'example_pg' AS ""Schema"", 'demo_table' AS ""Table"",
                            @Id::text AS ""Id"",
                            CASE
        ...
        public example_pg_demo_table? GetFromDb(IDbConnection connection, IDbTransaction transaction)
        {
            return connection.QueryFirstOrDefault<example_pg_demo_table>(this.GetSelectCommand(1), this, transaction);
        }
        ...
        {
            return $"id: {Id}; message: {Message}; type_id: {TypeId}; status: {Status}; date_test: {DateTest}; date_end_test: {DateEndTest}";
        }
    }

    public class example_pg_demo_table_type : IDtoBase
    {
        public const string TABLE_NAME = "example_pg.demo_table_type";
        [Da.DataType("uuid")]
        [Da.Key]
        public Guid Id { get; set; }
        ...
        public string GetSelectCommand(int maxCount = 1000, params string[] excludedColumns)
        {
            ...
            return $"select {cols.JoinColsForSelect(affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes)} from \"example_pg\".\"demo_table_type\" where (@Id::uuid is null or \"id\"=@Id) limit {maxCount}";
        }

        public string GetInsertCommand(bool returnScopeIdentity = false, params string[] excludedColumns)
        {
            var cols = "\"id\"|Id, \"name\"|Name".GetColumns(affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes, excludedColumns);
            var sql = $"insert into \"example_pg\".\"demo_table_type\" ({cols.JoinCols(false, affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes)}) values ({cols.JoinCols(true, affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes)})";
            if (returnScopeIdentity)
            {
                sql += " returning \"id\" as id";
            }
        ...
        {
            var cols = "\"id\"|Id, \"name\"|Name".GetColumns(affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes, excludedColumns);
            return $"update \"example_pg\".\"demo_table_type\" set {cols.JoinForUpdate(affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes)} where \"id\"=@Id";
        }

        public string GetDeleteCommand()
        {
            return "delete from \"example_pg\".\"demo_table_type\" where \"id\"=@Id";
        }

        public string GetDeleteAllCommand()
        {
            return "delete from \"example_pg\".\"demo_table_type\"";
        }
        ...
        public string GetSaveByIdCommand(bool select = false, params string[] excludedColumns)
        {
            ...
            return @$"
                        ...
                        SELECT 'example_pg' AS ""Schema"", 'demo_table_type' AS ""Table"",
                            @Id::text AS ""Id"",
                            CASE
                                WHEN EXISTS (SELECT 1 FROM upsert) THEN '{Constants.Updated}'
                                WHEN EXISTS (SELECT 1 FROM inserted) THEN '{Constants.Inserted}'
        ...
        public example_pg_demo_table_type? GetFromDb(IDbConnection connection, IDbTransaction transaction)
        {
            return connection.QueryFirstOrDefault<example_pg_demo_table_type>(this.GetSelectCommand(1), this, transaction);
        }
    ...
    public static class ExamplePgDemoTableTypes
    {
        ...
        public static string? GetExamplePgDemoTableTypesString(this Guid g)
        {
    ...
    public class example_pg_v_demo : IViewBase
    {
        public const string TABLE_NAME = "example_pg.v_demo";
        [Da.DataType("date")]
        public DateOnly? DateEndTest { get; set; }
        ...
        {
            var cols = "\"id\"|Id, \"message\"|Message, \"type_id\"|TypeId, \"status\"|Status, \"date_test\"|DateTest, \"date_end_test\"|DateEndTest".GetColumns(affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes, excludedColumns);
            return $"select {cols.JoinColsForSelect(affolterNET.Data.Extensions.QuoteStyle.DoubleQuotes)} from \"example_pg\".\"v_demo\" limit {maxCount}";
        }
