...
namespace ExamplePgUserDate.IntegrationTest.Commands
{
    ...
    public class SaveEntityCommandTest : IntegrationTest
    {
        ...
        public void SaveEntityCommandTestOk()
        {
            ...
            {
                var dto = new example_pg_user_date_demo_table
                {
                    Id = Guid.NewGuid(),
                    Message = "I was inserted!",
                    TypeId = ExamplePgUserDateDemoTableTypes.Drei
                };
                return new SaveEntityCommand<example_pg_user_date_demo_table>(dto, "tinu", true, example_pg_user_date_demo_table.Cols.Status);
