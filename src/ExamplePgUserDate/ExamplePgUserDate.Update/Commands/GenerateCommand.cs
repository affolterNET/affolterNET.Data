...
namespace ExamplePgUserDate.Update.Commands
{
    public class GenerateCommand : AsyncCommand<GenerateCommand.Settings>
    {
        ...
        public class Settings : CommandSettings
        {
            ...
            [DefaultValue("ExamplePgUserDate.Data")]
            public string NameSpace { get; set; } = null!;

            [CommandArgument(2, "[targetfile]")]
            [DefaultValue("../../ExamplePgUserDate.Data/Dto.cs")]
        ...
        {
            {
                var tlp = new GeneratorCfg()
                    ...
                    .WithContentsList("example_pg_user_date", "demo_table_type", "id", "name", "ExamplePgUserDateDemoTableTypes")
                    .WithUsing("System")
