...
namespace ExampleVersionUserDate.Update.Commands
{
    public class GenerateCommand : AsyncCommand<GenerateCommand.Settings>
    {
        ...
        public class Settings : CommandSettings
        {
            ...
            [DefaultValue("ExampleVersionUserDate.Data")]
            public string NameSpace { get; set; } = null!;

            [CommandArgument(2, "[targetfile]")]
            [DefaultValue("../../ExampleVersionUserDate.Data/Dto.cs")]
        ...
        {
            {
                var tlp = new GeneratorCfg()
                    ...
                    .WithContentsList("ExampleVersionUserDate","T_DemoTableType", "Id", "Name", "ExampleVersionUserDateDemoTableTypes")
                    .WithUsing("System")
