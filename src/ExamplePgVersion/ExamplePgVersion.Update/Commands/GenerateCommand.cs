...
namespace ExamplePgVersion.Update.Commands
{
    public class GenerateCommand : AsyncCommand<GenerateCommand.Settings>
    {
        ...
        public class Settings : CommandSettings
        {
            ...
            [DefaultValue("ExamplePgVersion.Data")]
            public string NameSpace { get; set; } = null!;

            [CommandArgument(2, "[targetfile]")]
            [DefaultValue("../../ExamplePgVersion.Data/Dto.cs")]
        ...
        {
            {
                var tlp = new GeneratorCfg()
                    ...
                    .WithContentsList("example_pg_version", "demo_table_type", "id", "name", "ExamplePgVersionDemoTableTypes")
                    .WithUsing("System")
