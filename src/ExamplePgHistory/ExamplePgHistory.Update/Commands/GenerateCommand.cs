...
namespace ExamplePgHistory.Update.Commands
{
    public class GenerateCommand : AsyncCommand<GenerateCommand.Settings>
    {
        ...
        public class Settings : CommandSettings
        {
            ...
            [DefaultValue("ExamplePgHistory.Data")]
            public string NameSpace { get; set; } = null!;

            [CommandArgument(2, "[targetfile]")]
            [DefaultValue("../../ExamplePgHistory.Data/Dto.cs")]
        ...
        {
            {
                var tlp = new GeneratorCfg()
                    ...
                    .WithContentsList("example_pg_history", "demo_table_type", "id", "name", "ExamplePgHistoryDemoTableTypes")
                    .WithUsing("System")
