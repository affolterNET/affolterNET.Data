...
namespace ExamplePgHistory.IntegrationTest.Commands
{
    ...
    public class SaveEntityCommandTest : IntegrationTest
    {
        ...
        public void SaveEntityCommandTestOk()
        {
            ...
            {
                var dto = new example_pg_history_demo_table
                {
                    Id = Guid.NewGuid(),
                    Message = "I was inserted!",
                    TypeId = ExamplePgHistoryDemoTableTypes.Drei
                };
                return new SaveEntityCommand<example_pg_history_demo_table>(dto, "tinu", true, example_pg_history_demo_table.Cols.Status);
