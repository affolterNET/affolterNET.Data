...
namespace ExamplePgHistory.Data
{
    public class DtoFactory : IDtoFactory
    {
        public IDtoBase Get<T>()
            where T : IDtoBase
        {
            if (typeof(example_pg_history_demo_table) == typeof(T))
            {
                return new example_pg_history_demo_table();
            }

            if (typeof(example_pg_history_demo_table_type) == typeof(T))
            {
                return new example_pg_history_demo_table_type();
            }
    ...
    public class ViewFactory : IViewFactory
    {
        public IViewBase Get<T>()
            where T : IViewBase
        {
            if (typeof(example_pg_history_v_demo) == typeof(T))
            {
                return new example_pg_history_v_demo();
            }
    ...
    public class example_pg_history_demo_table : IDtoBase
    {
        public const string TABLE_NAME = "example_pg_history.demo_table";
        [Da.DataType("uuid")]
        [Da.Key]
        ...
        {
            return "delete from \"example_pg_history\".\"demo_table\" where \"id\"=@Id";
        }

        public string GetDeleteAllCommand()
        {
            return "delete from \"example_pg_history\".\"demo_table\"";
        }
        ...
        {
            return $"id: {Id}; message: {Message}; type_id: {TypeId}; status: {Status}";
        }
    }

    public class example_pg_history_demo_table_type : IDtoBase
    {
        public const string TABLE_NAME = "example_pg_history.demo_table_type";
        [Da.DataType("uuid")]
        [Da.Key]
        public Guid Id { get; set; }
        ...
        public string GetDeleteCommand()
        {
            return "delete from \"example_pg_history\".\"demo_table_type\" where \"id\"=@Id";
        }

        public string GetDeleteAllCommand()
        {
            return "delete from \"example_pg_history\".\"demo_table_type\"";
        }
    ...
    public static class ExamplePgHistoryDemoTableTypes
    {
        ...
        public static string? GetExamplePgHistoryDemoTableTypesString(this Guid g)
        {
    ...
    public class example_pg_history_v_demo : IViewBase
    {
        public const string TABLE_NAME = "example_pg_history.v_demo";
        [Da.DataType("uuid")]
        public Guid? Id { get; set; }
