...
namespace ExampleVersionUserDateHistory.Update.Commands
{
    public class GenerateCommand : AsyncCommand<GenerateCommand.Settings>
    {
        ...
        public class Settings : CommandSettings
        {
            ...
            [DefaultValue("ExampleVersionUserDateHistory.Data")]
            public string NameSpace { get; set; } = null!;

            [CommandArgument(2, "[targetfile]")]
            [DefaultValue("../../ExampleVersionUserDateHistory.Data/Dto.cs")]
        ...
        {
            {
                var tlp = new GeneratorCfg()
                    ...
                    .WithContentsList("ExampleVersionUserDateHistory","T_DemoTableType", "Id", "Name", "ExampleVersionUserDateHistoryDemoTableTypes")
                    .WithUsing("System")
